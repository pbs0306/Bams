  ...
  <header>
    ...
    <div id="logo">
      <a href="NonageServlet?command=index">
        <img src="images/logo4.png" width="180" height="100" alt="nonageshop">
      </a>  
    </div>
    <!--로고 들어가는 곳 끝-->     
    ...
    <nav id="top_menu">
      <ul>
        <li>
          <a href="NonageServlet?command=catagory&kind=1">Potion</a>
        </li>  
        <li>
          <a href="NonageServlet?command=catagory&kind=2">Weapon</a>
        </li>  
        <li>
          <a href="NonageServlet?command=catagory&kind=3">Armor</a>
        </li> 
        <li>
          <a href="NonageServlet?command=catagory&kind=4">Magic</a>
        </li> 
        <li>
