...
method="post" name="formm" style="color:lime; background-color:black">
        언제나 새로운 즐거움이 가득한 Itcu의 회원가입 페이지 입니다. <br>
       Itcu의 회원가입은 무료이며, 회원님의 개인신상에 관한 정보는 
       ‘정보통신망이용촉진 및 정보보호등에관한법률’에 의해 회원님의 동의없이
         제 3자에게 제공되지 않으며, 철저히 보호되고 있사오니 안심하고 이용하시기 바랍
니다.<br><br>
       <textarea rows="15" cols="100" style="color:lime; background-color:black">
       제 1 장 총 칙

제 1 조 (목적) 
이 이용약관(이하 '약관')은 주식회사 Itcu(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 Itcu.com서비스의 가입조건 및 이용에 관한 다음의 제반 사항과 기타 기본적인 사항을 구체적으로 규정함을 목적으로 합니다.

제 2 조 (이용약관의 효력 및 변경) 
(1) 이 약관은 Itcu 웹사이트(www.Itcu.com 이하 'Itcu 웹')에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.
...
제 4 조 (용어의 정의) 
(1) "이용자" 또는”회원”이란 "Itcu"에 접속하여 본 약관에 따라 "Itcu"에 가입하여, 이용 고객의 식별과 이용고객의 서비스 이용을 위하여 이용고객 본인이 직접 선정하고 회사가 부여하는 문자와 숫자 조합인 ‘이용자번호(ID)’와 그에 따라 일치된 이용고객임을 확인하기 위하여 이용고객 본인이 선정한 ‘비밀번호’를 이용하여 "Itcu"이 제공하는 서비스를 받는 자를 말합니다.
...
제 7 조 (이용자의 개인 정보 보호) 
회사는 관련법령이 정하는 바에 따라서 이용자 등록정보를 포함한 이용자의 개인정보를 보호하기 위하여 노력합니다. 이용자의 개인정보보호에 관해서는 관련법령 및 "Itcu"이 정하는 "개인정보보호정책"에 정한 바에 의합니다.
...
(3) ‘Itcu’의 이용자ID는 이용자 본인의 동의하에 ‘Itcu’ 가 운영하는 자사 사이트의 회원ID와 연결될 수 있습니다.
